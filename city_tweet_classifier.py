...
# This function parses, tokenizes the test file and returns a dictionary with
...
# The actual function that calculates the posterior probability. A factor of
...
f1 = str(sys.argv[1])
f2 = str(sys.argv[2])
f3 = str(sys.argv[3])old_city= ['Los_Angeles,_CA', 'San_Francisco,_CA','San_Diego,_CA', 'Houston,_TX','Chicago,_IL','Philadelphia,_PA',
